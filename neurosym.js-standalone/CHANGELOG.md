...
### Added
- Expanded test coverage for NeuroJSON v0.1 compiler and sampler paths.
- Coverage for query filtering, evidence stats, and warnings.

### Changed
- Release prep for npm publish (version bump and docs alignment).
